...
impl<E: Engine> SyEval<E> {
    ...
    pub fn finalize(self, y: E::Fr) -> E::Fr {
        ...
        let positive_powers_contrib =
            evaluate_at_consequitive_powers(&self.positive_coeffs[..], y, y);
        let negative_powers_contrib =
            evaluate_at_consequitive_powers(&self.negative_coeffs[..], yinv, yinv);
